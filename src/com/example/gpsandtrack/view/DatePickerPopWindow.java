package com.example.gpsandtrack.view;
...
import com.example.gpsandtrack.MainActivity;
import com.example.gpsandtrack.R;
import com.example.gpsandtrack.adapter.NumericWheelAdapter;
	...
	private void initWindow() {
		...
		tv_ok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(MainActivity.ACTION_OK);
		...
		tv_cancel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(MainActivity.ACTION_CANCEL);
				context.sendBroadcast(intent);  
			}
		});
	}
