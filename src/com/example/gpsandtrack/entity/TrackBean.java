package com.example.gpsandtrack.entity;
...
public class TrackBean {
    ...
    public class Points {
        ...
        public String device_id; // 设备编号 string�?当service的type�?�?，且为该属�?赋过值才会返�?
        public double radius; // GPS定位精度 当service的type�?�?�?�?，且创建该track的时候输入了这个字段才会返回�?
        public double realtime_poiid;
        public int direction; // GPS方向 当service的type�?，且创建该track的时候输入了这个字段才会返回�?
        public double speed; // GPS速度当service的type�?，且创建该track的时候输入了这个字段才会返回�?
